...
minday=datenum([2012 09 12 0 0 0]);
maxday=datenum([2012 09 13 0 0 0]);
...
screen2png('lalinet_argentina_day12.png');
...
title('ma-MA');
prettify(gca,bar); grid on; 
screen2png('lalinet_manaus_day12.png');
...
prettify(gca,bar); grid on; 
screen2png('lalinet_saopaulo_day12.png');
...
prettify(gca,bar); grid on; 
screen2png('lalinet_chile_day12.png');
%