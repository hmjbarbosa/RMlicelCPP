...
%    wjdi(34)=datenum('05-Aug-2011 02:23:49'); wjdf(34)=datenum('05-Aug-2011 06:02:38');
    ...
    % campanha
    nw=1;
    wjdi(01)=datenum('29-Aug-2011 12:00:00'); wjdf(01)=datenum('07-Sep-2011 12:00:00');
  else
    %% WET - CEU LIMPO
    nw=21;
...
%    for q=692:nfile
    for q=1:nfile
      ...
      Pr2(:,1) = P(:,1).*altsq(:);
      signal_aero(:,q+totfile)=P(:,1);
      signalr2_aero(:,q+totfile)=Pr2(:,1);
  ...
  if (totfile>0)
    out=['signal_' tag{z} '_overlapfinal_set2011.mat'];
    save(out,'signal_aero','signalr2_aero','totheads')
  end
end
%
