...
set([hxl, hyl, hzl], 'FontName', 'AvantGarde', 'FontSize', 14);
set([bar], 'FontName', 'AvantGarde', 'FontSize', 12);
leg=legend('Data','y=x','y=p1*x+p2','Location','NorthWest');

prettify(gca,bar,leg); grid on;                 
...
leg=legend('Lidar','Aeronet','Terra','Aqua','Location','NorthWest');
prettify(gca,bar,leg); grid on;                 
%set(gcf, 'PaperPositionMode', 'auto');
