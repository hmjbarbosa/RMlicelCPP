...
prettify(gca); grid on;ylim([0 20])
print('earlinet_betamol.png','-dpng');
hold off
%
%
% -------------
...
set(gcf,'PaperUnits','inches','PaperSize',[3,9],'PaperPosition',[0 0 3 7.8]);
prettify(gca); grid on;ylim([0 20]); xlim([0 15e8])
print('earlinet_Pr2_fit.png','-dpng');
%
% -------------
figure
temp=get(gcf,'position'); temp(3)=260; temp(4)=650;
...
set(gcf,'PaperUnits','inches','PaperSize',[3,9],'PaperPosition',[0 0 3 7.8]);
prettify(gca); grid on;ylim([0 20]); xlim([15 22]);
print('earlinet_logPr2_fit.png','-dpng');
%
