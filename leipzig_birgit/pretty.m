...
% To make it more publication-quality, I make the following changes to
% the line properties, including the errorbar widths. In my opinion,
% using thicker lines and larger markers greatly improves the "look"
% of my graphics. It's quite subjective, but I select them based on
% how much data is on the graph. I select the appropriate
% "crowdedness" (balance of dark and white space):
